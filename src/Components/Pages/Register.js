...
import {
    Container, Header, ExtraHeader, Content, Row, Button, Icon, Input
} from '../Widgets';
                ...
                <Content fill>
                    <KeyboardAwareScrollView contentContainerStyle={styles.contentWrapper}>
                        ...
                        <Input
                            ...
                            onChangeValue={this.onChangeValue}
                        />
                        <TouchableOpacity onPress={() => {this.onGoToSupport()}}>
                            <Text style={styles.noticeTitle}> 
                             Bấm vào nút đăng ký đồng nghĩa với việc bạn đồng ý với điều khoản sử dụng của dịch vụ
                            </Text>
                        </TouchableOpacity>
